...
(function(){
  ...
  const STR = {
    ...
    quizAllChapters: { zh:"BioTuring 互動考題（全部章節）", en:"BioTuring Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"BioTuring 互動考題", en:"BioTuring Interactive Quiz" },
